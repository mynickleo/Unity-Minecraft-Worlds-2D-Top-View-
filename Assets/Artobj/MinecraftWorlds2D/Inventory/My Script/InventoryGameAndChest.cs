...
public class InventoryGameAndChest : MonoBehaviour
{
    public Item[] ItemsInventory = new Item[63];

    public Inventory_visible_for_chest Inventory_Visible;
    ...
    public void LoadAllInventory()
    {
        ...
        for (int i = 36; i < 63; i++)
        {
            ItemsInventory[i] = InventoryChest.GetComponent<Inventory_Chest>().ItemsInventory[j];
            j++;
        }
    }
    ...
    public void SaveInventoryToFile()
    {
        ...
        for (int i = 36; i < 63; i++)
        {
            InventoryChest.GetComponent<Inventory_Chest>().ItemsInventory[j] = ItemsInventory[i];
            j++;
        }
        for (int i = 0; i < 36; i++)
        {
        ...
        InventoryChest.GetComponent<Inventory_Chest>().SaveInventoryToFile();
        InventoryChest.GetComponent<Inventory_Chest>().LoadAllInventory();
