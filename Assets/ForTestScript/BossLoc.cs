...
public class BossLoc : MonoBehaviour
{
    //Специальный скрипт для загрузки локации Босса
    ...
    void LateUpdate()
    {
        ...
        {
            foreach (Transform child in GameObject.Find("Boss_Location(Clone)").GetComponentInChildren<Transform>())
            {
